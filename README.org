...
I've now been able to locate each slide (inside [[./example/simple-presentation.org][simple-presentation.org]]) and the data structures for the svg images "elements".
